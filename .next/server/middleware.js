...
;// CONCATENATED MODULE: ./lib/app/session.ts
const DEMO_SESSION_COOKIE = "ceorader_demo_session";
const DEMO_SESSION_VALUE = "active";
const DEMO_SESSION_MAX_AGE = (/* unused pure expression or super */ null && (60 * 60 * 24 * 30));
...
function isPublicPath(pathname) {
    return PUBLIC_PATHS.some((path)=>pathname === path || pathname.startsWith(`${path}/`)) || PUBLIC_PREFIXES.some((prefix)=>pathname === prefix || pathname.startsWith(`${prefix}/`));
}
